class L10n {
  ...
  String get signInSubtitle => isAr ? 'تسجيل الدخول لحساب رحلاتك' : 'Sign in to start your journey and calculate your earnings.';
  ...
  String get continueWithGoogle => isAr ? 'الاستمرار بجوجل' : 'Continue with Google';
  String get useAccountBelow => isAr ? 'استخدم الحساب أدناه لتسجيل الدخول.' : 'Use the account below to sign in.';

  String get createAccount => isAr ? 'إنشاء حساب جديد' : 'Create an account';
  String get createAccountSubtitle => isAr ? 'أدخل بياناتك للبدء في حساب تكلفة مشاوريك.' : "Let's get started by filling out the form below.";
  ...
  String get yourEmailAddress => isAr ? 'عنوان بريدك الإلكتروني' : 'Your email address...';
  ...
  String get startNewTrip => isAr ? 'حساب رحلة جديدة +' : '+ Start New Trip Calculation';
  ...
  String get destinationHint => isAr ? 'دبي مول، وسط المدينة' : 'Dubai Mall, Downtown';
  ...
  String get totalEarningsMonth => isAr ? 'إجمالي الأرباح (الشهر)' : 'Total Earnings (Month)';
  ...
  String get personalInfoSub => isAr ? 'الاسم، البريد الإلكتروني، رقم الهاتف' : 'Name, email, phone number';
  String get payoutSettings => isAr ? 'إعدادات الدفع' : 'Payout Settings';
  String get payoutSettingsSub => isAr ? 'حساب البنك وطرق الدفع' : 'Bank account & payment methods';
  ...
  String get darkModeDesc => isAr ? 'ضبط المظهر البصري للتطبيق' : "Adjust the app's visual theme";
  ...
  String get tripAlertsDesc => isAr ? 'مسار الطريق في الوقت الفعلي' : 'Real-time route';

  // Days of week
  List<String> get weekDays => isAr
      ? ['الاثنين', 'الثلاثاء', 'الأربعاء', 'الخميس', 'الجمعة', 'السبت', 'الأحد']
      : ['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'];
  List<String> get weekDaysShort => isAr
      ? ['أ', 'ث', 'أ', 'خ', 'ج', 'س', 'أ']
      : ['M', 'T', 'W', 'T', 'F', 'S', 'S'];
}
